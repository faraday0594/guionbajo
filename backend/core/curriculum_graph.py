...
CURRICULUM_GRAPH: Dict[str, Dict[str, Any]] = {   'A1.1': {   'title': 'A1.1 — Getting Started',
    ...
    'A2.4': {   'title': 'A2.4 — Communication',
                ...
                'classes': [   {   'class_index': 1,
                               ...
                               {   'class_index': 3,
                                   ...
                                   'grammar_core': 'Core Spatial Phrasal Verbs (get in/out, sit down, stand up, turn on/off, pick up, put down), Particle Directionality',
                                   'vocabulary_core': 'Daily household routines, Physical movement, Device handling, Workspace actions',
                                   'phonetic_contrast': None,
                                   'phonetic_focus_title': None,
                                   'retrieval_topics': ['Relative Clauses Introduction'],
                                   'target_skills': ['vocabulary', 'speaking', 'pronunciation'],
                                   'can_do': 'Can use essential physical and spatial phrasal verbs naturally using particle direction.'},
                               {   'class_index': 4,
    ...
    'B1.2': {   'title': 'B1.2 — Opinions & Communication',
                ...
                'classes': [   {   'class_index': 1,
                               ...
                               {   'class_index': 3,
                                    ...
                                    'grammar_core': 'Metaphorical Extensions of OUT (Discovery: find out, Exhaustion: run out, Resolution: figure out) & UP (Telicity: clean up, Increase: turn up, Creation: come up with)',
                                    'vocabulary_core': 'Workplace investigations, Problem solving, Resource management, Daily achievements',
                                    'phonetic_contrast': None,
                                    'phonetic_focus_title': None,
                                    'retrieval_topics': ['Giving Opinions & Linking Expressions', 'Modals of Deduction'],
                                    'target_skills': ['vocabulary', 'grammar', 'speaking'],
                                    'can_do': 'Can deduce and naturally apply the multi-context metaphorical extensions of OUT and UP.'},
                               {   'class_index': 4,
                                    'topic': 'B1.2 Integration: Opinions, Deductions & Phrasal Fluency',
                                    'grammar_core': 'Debate, Deductions & Phrasal Verb Synthesis (Opinions, Deduction, Particle Logic)',
                                    'vocabulary_core': 'Critical thinking, Evidence analysis, Collaborative dialogue, Solution building',
                                    'phonetic_contrast': None,
                                    'phonetic_focus_title': None,
                                    'retrieval_topics': [   'Giving Opinions & Linking Expressions',
                                                            'Comparisons & Preferences',
                                                            'Phrasal Verbs: Cognitive Logic of OUT & UP'],
                                    'target_skills': ['speaking', 'debate', 'assessment'],
                                    'can_do': 'Can lead an interactive discussion, counter-argue politely, and resolve issues using cognitive phrasal verbs.'}]},
    ...
    'B1.4': {   'title': 'B1.4 — Complex Everyday English',
                ...
                'classes': [   {   'class_index': 1,
                               ...
                               {   'class_index': 3,
                                   ...
                                   'grammar_core': 'Particle Semantics: OFF (Separation/Postponement: call off, put off, take off), ON (Continuity: carry on, go on), AWAY (Distance/Storage: give away, put away), BACK (Return/Reciprocity: pay back, call back)',
                                   'vocabulary_core': 'Project scheduling, Social agreements, Financial settlements, Resource stewardship',
                                   'phonetic_contrast': None,
                                   'phonetic_focus_title': None,
                                   'retrieval_topics': ['Reported Speech', 'Relative Clauses Introduction'],
                                   'target_skills': ['vocabulary', 'grammar', 'speaking'],
                                   'can_do': 'Can apply the systematic trajectories of OFF, ON, AWAY, and BACK to complex communication.'},
                               {   'class_index': 4,
    ...
    'B2.2': {   'title': 'B2.2 — Natural English',
                ...
                'prerequisites': ['B2.1'],
                'classes': [   {   'class_index': 1,
                                   'topic': 'Phrasal Verbs: Advanced Cognitive Semantics & Multi-Particle Networks',
                                   'grammar_core': 'Cognitive Particle Networks (OUT, UP, DOWN, OFF, IN, THROUGH, OVER), Metaphorical shifts in executive/formal registers (iron out, step down, look over, follow through, phase out)',
                                   'vocabulary_core': 'Executive strategy, Corporate negotiations, Conflict mediation, Organizational restructuring',
                                   'phonetic_contrast': None,
                                   'phonetic_focus_title': None,
                                   'retrieval_topics': ['Phrasal Verbs: Particle Semantics of OFF, ON, AWAY & BACK'],
                                   'target_skills': ['vocabulary', 'grammar', 'pronunciation'],
                                   'can_do': 'Can navigate complex multi-particle networks and interpret nuanced figurative meanings spontaneously.'},
                               {   'class_index': 2,
                                   'topic': 'Three-Part Phrasal Verbs & Separability Mechanics',
                                   'grammar_core': 'Transitive vs Intransitive, Separable vs Inseparable syntax (pronoun placement: figure it out), Three-part phrasal structures (come up with, cut down on, look down on, put up with)',
                                   'vocabulary_core': 'Interpersonal dynamics, Operational efficiency, Professional resilience',
                                   'phonetic_contrast': ['/k/', '/g/'],
                                   'phonetic_focus_title': 'Contraste velar oclusivo /k/ (cat) vs /g/ (goat)',
                                   'retrieval_topics': ['Phrasal Verbs: Advanced Cognitive Semantics & Multi-Particle Networks'],
                                   'target_skills': ['vocabulary', 'speaking', 'fluency'],
                                   'can_do': 'Can master syntactic placement of object pronouns and accurately deploy three-part phrasal verbs.'},
                               {   'class_index': 3,
                                   ...
                                   'phonetic_contrast': None,
                                   'phonetic_focus_title': None,
                                   'retrieval_topics': ['Three-Part Phrasal Verbs & Separability Mechanics'],
                                   'target_skills': ['vocabulary', 'speaking', 'fluency'],
                                   'can_do': 'Can incorporate common idioms and fixed collocations without sounding '
                                             'forced.'},
                               {   'class_index': 4,
                                   'topic': 'Advanced Verb Patterns & B2.2 Integration',
                                   'grammar_core': 'Gerund vs Infinitive with Meaning Change (remember, stop, forget, '
                                                   'regret) + Phrasal & Idiom Capstone',
                                   'vocabulary_core': 'Decision making, Psychological reflections, Spontaneous '
                                                      'conversational flow',
                                   'phonetic_contrast': None,
                                   'phonetic_focus_title': None,
                                   'retrieval_topics': [   'Phrasal Verbs: Advanced Cognitive Semantics & Multi-Particle Networks',
                                                           'Three-Part Phrasal Verbs & Separability Mechanics',
                                   ...
                                   'can_do': 'Can sustain a lively, natural conversation using varied idiomatic '
                                             'phrases, complex verb patterns and smooth linking.'}]},
